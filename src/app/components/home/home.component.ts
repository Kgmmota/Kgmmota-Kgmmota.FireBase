...
import { MovieInterface } from '../../shared/interface/movie-interface';
...
export class HomeComponent {
  ...
  ngOnInit(){
    this.databaseServices.getCollection('movies').subscribe((movies: MovieInterface[])=>{
      this.movies = movies;
  ...
  deleteMovie(id:string){
    this.databaseServices.deleteDocument('movies',id).then(()=>{
